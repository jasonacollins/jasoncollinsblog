...
To get an intuition for this, a long run of equal numbers of heads and tails is equivalent to flipping a head and a tail every two periods. Suppose that is exactly what you did - flipped a head and then flipped a tail. Your wealth would increase to \$150 in the first round (\$100\*1.5), and then decline to \$90 in the second (\$150\*0.6). You get the same result if you change the order. Effectively, you are losing 10% (or getting only 1.5\*0.6=0.9) of your money every two periods.
