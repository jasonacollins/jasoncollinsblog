...
I first wrote a version of this post in April 2023. This is the latest.
...
CoPilot gives me access to whatever language models Microsoft is running behind it. I assume this is currently GPT-4, and I would say the performance of CoPilot has continued to incrementally improve.
...
In my first year teaching the undergraduate behavioural economics subject in 2023, the subject was structured as two hours of live (but online) lectures and one hour of tutorials (either online or in-person). Both lectures and the online tutorial were recorded, so students could watch at another time. The net result was limited attendance, and most students didn't watch the videos either.

Last year I decided to move the subject out of the 1950s and make it a combination of some [short pre-recorded videos](https://www.youtube.com/@jasonacollins), interactive online seminars and tutorials. This approach backfired. The students didn't watch the videos and didn't want to interact (as I decribe in my review of Bryan Caplan's The Case Against Education).
