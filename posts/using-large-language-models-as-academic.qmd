...
To access CoPilot, I write in [Visual Studio Code](https://code.visualstudio.com). Since I started blogging (12 years now!) I have always written in markdown (and at the moment a particular flavour of markdown, [Quarto](https://quarto.org)). Before the emergence of CoPilot, I wrote using a mix of [RStudio](https://posit.co/download/rstudio-desktop/), Visual Studio Code and other text editors that support markdown and allow me to render to HTML and pdf. With CoPilot not available in RStudio, I'm almost exclusively in Visual Studio Code now. For those who want more specific guidance on how to set this up, I've added that at the bottom of this post.
